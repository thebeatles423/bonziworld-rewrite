    ...
    const socket = io("//" + window.location.hostname + ":" + window.location.port, { transports: ['websocket'] });
$(function(){
    ...
    const stage = new createjs.StageGL("bonzi-canvas", { transparent: true, antialias: true });
    ...
    socket.on("adduser", (data) => {
        ...
        $element.css({ marginLeft: bonzi.sprite.x, marginTop: bonzi.sprite.y }), 
